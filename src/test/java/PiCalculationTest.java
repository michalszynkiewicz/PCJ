...
public class PiCalculationTest  extends Storage implements StartPoint {
    ...
    public void main() throws Throwable {
        int pointCount = Integer.valueOf(System.getProperty("pointCount"));
        ...
        if (PCJ.myId() == 0) {
            ...
            for (int i = 0; i < PCJ.threadCount(); i++) {
                try {
                    System.out.println("Adding result from: " + i);
    ...
    public static void main(String[] args) {
        ...
        PCJ.deploy(PiCalculationTest.class, PiCalculationTest.class, System.getProperty("nodes").split(","));
    }
}
